...
Description:
Display this CTA when the user is asking about therapies in general or is seeking guidance on therapy options without mentioning a specific therapy.
...
- List all therapies.
- Explain the therapies available.
- What therapy information do you have?
- Tell me about the therapies on ManaScience.

## Therapy Discovery
- What therapy options are there?
- What therapies help children?
- What therapies are available for learning difficulties?
- What therapies are available for developmental challenges?
- What therapies support neuroplasticity?
...
- Can you guide me on therapy options?
- I'm not sure which therapy to prefer.
- Which therapy is suitable for us?
...
## Navigation Requests
- Take me to the therapy page.
- Open the therapy library.
- Show the therapy library.
- Browse therapies.
- View all therapies.
- Explore therapy options.
- Show therapy information.
- Therapy library.
- Therapy section.
- Open therapies.
- Go to therapies.
...
If a specific therapy has already been identified.
...
If the user's intent is related to therapies but no specific therapy is detected, display this Therapy Library CTA.

Output Label:

Explore the Therapy Library

CTA:

https://manascience.webflow.io/therapy-library
